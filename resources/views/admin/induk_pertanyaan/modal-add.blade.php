<div class="modal fade" id="modal-add-induk_pertanyaan">
    <div class="modal-dialog modal-lg modal-dialog-scrollable">
        <div class="modal-content">
            <div class="modal-header px-4">
                <h5 class="mb-0">Tambah Pertanyaan</h5>
                <button type="button" class="btn-close btn-sm" data-bs-dismiss="modal" data-bs-target="#modal-add-induk_pertanyaan"></button>
            </div>
            <div class="modal-body px-4">
                <form method="post" id="form-add-pertanyaan" spellcheck="false">
                    ...
                    <div class="d-flex justify-content-end">
                        <button type="button" data-bs-dismiss="modal" data-bs-target="#modal-add-induk_pertanyaan" class="btn btn-danger me-3">Batal</button>
