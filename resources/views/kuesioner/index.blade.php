...
@section('content')
    ...
    <div class="card" style="width: 18rem;">
        <img src="{{ asset('survei2.png') }}" class="card-img-center" alt="...">
        <div class="card-body">
        <button type="button" class="btn btn-success mb-5" data-bs-toggle="modal" id="btn-isi-survey" data-bs-target="#modal-isi-survey">Isi Survey</button>
            {{-- Survey Question --}}
